...
gboolean tyon_dbus_emit_profile_data_changed_outside(DBusGProxy *proxy, guint profile_number);
gboolean tyon_dbus_emit_profile_data_changed_outside_instant(guint profile_number);
gboolean tyon_dbus_emit_profile_changed_outside(DBusGProxy *proxy, guint profile_number);
gboolean tyon_dbus_emit_profile_changed_outside_instant(guint profile_number);
